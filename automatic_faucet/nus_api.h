...
extern void set_blue_led_high( void );
extern void set_blue_led_low( void );
extern void set_led_level_high( const int ledPort );
extern void set_led_level_low( const int ledPort );
