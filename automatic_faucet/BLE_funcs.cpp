...
// 
// ****************************************
// extern "C" void set_blue_led_high( void ){
//   am_hal_gpio_output_set(LED_BUILTIN);
// }

// extern "C" void set_blue_led_low( void ){
//   am_hal_gpio_output_clear(LED_BUILTIN);
// }

// extern "C" void set_led_level_high(const int ledPort) {
//     am_hal_gpio_output_set(ledPort);
// }

// extern "C" void set_led_level_low(const int ledPort) {
