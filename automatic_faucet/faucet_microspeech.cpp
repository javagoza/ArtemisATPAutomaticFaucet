...
FaucetMicrospeech::FaucetMicrospeech(){}

FaucetMicrospeech::~FaucetMicrospeech(){}

void FaucetMicrospeech::begin(tflite::ErrorReporter *error_reporter) {
...
void FaucetMicrospeech::process(tflite::ErrorReporter *error_reporter, bool activate_valves)  {
    ...
    RespondToCommand(error_reporter, current_time, found_command, score,
                     is_new_command, activate_valves);
}